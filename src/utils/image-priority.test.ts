...
function createMockImage(
  ...
  Object.defineProperty(img, 'naturalWidth', {
    value: dimensions.width || 800,
  });
  Object.defineProperty(img, 'naturalHeight', {
    value: dimensions.height || 600,
  });
...
describe('Viewport Detection', () => {
  ...
  describe('calculateImagePriority', () => {
    it('should give higher priority to viewport images', () => {
      const inViewportImg = createMockImage({
        top: 100,
        left: 100,
        bottom: 200,
        right: 300,
      });
      const outsideViewportImg = createMockImage({
        top: 1000,
        left: 100,
        bottom: 1100,
        right: 300,
      ...
      const outsideViewportPriority =
        calculateImagePriority(outsideViewportImg);
...
describe('Parallel Processing', () => {
  describe('processInParallel', () => {
    ...
    it('should call onItemComplete callback', async () => {
      ...
      await processInParallel(items, async item => item, {
        maxConcurrent: 1,
        onItemComplete,
      });
  ...
  describe('processImagesOptimized', () => {
    ...
    it('should process images in viewport-first order', async () => {
      const outsideImg = createMockImage({
        top: 1000,
        left: 100,
        bottom: 1100,
        right: 300,
      });
      const insideImg = createMockImage({
        top: 100,
        left: 100,
        bottom: 200,
        right: 300,
