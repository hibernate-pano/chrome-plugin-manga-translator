...
export class QwenProvider extends AIProvider {
  ...
  async detectText(imageData, options = {}) {
    ...
    try {
          ...
          messages: [
            {
              ...
              content: [
                ...
                {
                  type: 'image',  // 注意这里使用'image'而不是'image_url'
                  image_url: {
      ...
      console.error('Qwen文字检测失败:', error);
      throw error;
    }
  }
  ...
  getConfigurationSchema() {
    return {
      ...
      apiBaseUrl: { type: 'string', required: true, label: 'API基础URL', default: 'https://api.siliconflow.cn/v1' },
      model: { 
        type: 'select', 
        required: true, 
        label: '模型', 
        ...
        options: [
          { value: 'Qwen/Qwen2.5-VL-32B-Instruct', label: 'Qwen2.5-VL-32B' },
          ...
          { value: 'Qwen/Qwen2.5-4B-Instruct', label: 'Qwen2.5-4B' },
